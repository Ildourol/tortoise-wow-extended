    ...
    */
    ...
    public:
        ...
        virtual bool IsActive() override
        {
            ...
            // Unit calculated values cache raw Unit pointers.
            // Force target values to be recalculated before using them so we do not
            // use a unit that has despawned or left the battleground.
