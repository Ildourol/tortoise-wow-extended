    ...
    namespace paladin
    {
        ...
        public:
            TriggerFactoryInternal()
            {
                ...
                creators["bulwark of the righteous"] = [](PlayerbotAI* ai) { return new BulwarkOfTheRighteousTrigger(ai); };
        ...
        class ValueFactoryInternal : public NamedObjectContext<UntypedValue>
        {
        public:
        ...
        public:
            AiObjectContextInternal()
            {
                ...
                creators["bulwark of the righteous"] = [](PlayerbotAI* ai) { return new CastBulwarkOfTheRighteousAction(ai); };
...
PaladinAiObjectContext::PaladinAiObjectContext(PlayerbotAI* ai) : AiObjectContext(ai)
{
    ...
    valueContexts.Add(new ai::paladin::ValueFactoryInternal());
}
